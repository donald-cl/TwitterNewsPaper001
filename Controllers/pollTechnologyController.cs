...
{
    public class pollTechnologyController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("laptop"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.technologyTweets, pubtl.technologyFilter);
            return pubtl.ConcatTweets(pubtl.technologyTweets);
        }
