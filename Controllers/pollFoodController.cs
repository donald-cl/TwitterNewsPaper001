...
{
    public class pollFoodController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("wine"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.foodTweets, pubtl.foodFilter);
            return pubtl.ConcatTweets(pubtl.foodTweets);
        }
