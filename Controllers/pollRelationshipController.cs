...
{
    public class pollRelationshipController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("love"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.relationshipTweets, pubtl.relationshipFilter);
            return pubtl.ConcatTweets(pubtl.relationshipTweets);
        }
