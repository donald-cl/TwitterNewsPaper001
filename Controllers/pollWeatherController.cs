...
{
    public class pollWeatherController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("cold"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.weatherTweets, pubtl.weatherFilter);
            return pubtl.ConcatTweets(pubtl.weatherTweets);
        }
