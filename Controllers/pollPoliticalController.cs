...
{
    public class pollPoliticalController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("president"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.politicalTweets, pubtl.politicalFilter);
            return pubtl.ConcatTweets(pubtl.politicalTweets);
        }
