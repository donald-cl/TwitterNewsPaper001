...
{
    public class pollOccasionController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("birthday"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.occasionTweets, pubtl.occasionFilter);
            return pubtl.ConcatTweets(pubtl.occasionTweets);
        }
