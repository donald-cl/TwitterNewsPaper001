...
{
    public class pollMusicController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("song"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.musicTweets, pubtl.musicFilter);
            return pubtl.ConcatTweets(pubtl.musicTweets);
        }
