...
{
    public class pollStarcraftController : Controller
    {
        ...
        public String Index()
        {
            ...
            if (debug) { publicTimeLine = TestPoll("jaedong"); }
            pubtl.InitializeFilters();
            pubtl.FilterTimeLine(publicTimeLine, pubtl.starcraftTweets, pubtl.starcraftFilter);
            return pubtl.ConcatTweets(pubtl.starcraftTweets);
        }
